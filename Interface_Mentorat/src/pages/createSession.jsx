...
const CreateSession = () => {
  ...
  const validateForm = () => {
    ...
    if (!sessionData.menteeId)
      newErrors.menteeId = "Veuillez sélectionner un apprenti";
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl p-8 space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-gray-300 text-sm">
              Planifiez votre prochaine session de mentorat
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              {errors.menteeId && (
                <p className="text-red-400 text-xs mt-1">{errors.menteeId}</p>
              )}
            </div>
