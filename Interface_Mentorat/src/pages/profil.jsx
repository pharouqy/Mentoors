            ...
            <div className="grid gap-4">
              {data && data.map((userItem) => (
                <div key={userItem.id} className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition-all duration-200">
                  <div className="flex items-center justify-between flex-wrap justify-center space-y-2">
                    <div className="flex items-center space-x-4">
                      <div className="w-12 h-12 bg-gradient-to-r from-cyan-400 to-purple-5x00 rounded-xl flex items-center justify-center">
                    ...
                    <div className="flex space-x-3 flex-wrap justify-center space-y-2">
                      <button
                        onClick={() => navigate(`/update/${userItem.id}`)}
                        className="bg-gradient-to-r from-blue-400 to-cyan-500 hover:from-blue-500 hover:to-cyan-600 text-white px-4 py-2 rounded-lg font-medium transition-all duration-200 hover:scale-105 flex items-center mt-2 ml-2"
                      >
